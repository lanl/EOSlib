...
BKW_VT::BKW_VT(BKW &eos) : EOS_VT("BKW")
{
    Transfer(eos);
    V0 = eos.V0;
    e0 = eos.e0;
...
void BKW_VT::PrintParams(ostream &out)
{
...
#undef  FUNC
#define FUNC "BKW_VT::ConvertParams",__FILE__,__LINE__,this
int BKW_VT::ConvertParams(Convert &convert)
{
...
#undef  FUNC
#define FUNC "BKW_VT::InitParams",__FILE__,__LINE__,this
#define calcvar(var) calc.Variable(#var,&var)
int BKW_VT::InitParams(Parameters &p, Calc &calc, DataBase *)
{
    V0 = NaN;
    e0 = 0.0;
    P0 = 0.0;
